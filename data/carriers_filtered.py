...
def get_filtered_carriers():
    """Get carriers with filters for user page"""
...
def get_filtered_carriers_json():
    """API endpoint for filtered carriers"""
    carriers = get_filtered_carriers()
